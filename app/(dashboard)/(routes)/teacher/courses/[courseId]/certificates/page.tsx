          ...
          <TabsContent value="template" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload a custom certificate template for this course. Students will automatically
                  receive certificates when they meet all requirements.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="requirements" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set the requirements students must meet to earn a certificate
                </CardDescription>
              </CardHeader>
              <CardContent>
