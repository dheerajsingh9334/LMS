...
const CourseOverviewPage = async ({
  ...
  const previewChapters = course.chapters.filter(
    (chapter) => chapter.isPreview
  );
                ...
                {previewChapters.length > 0 && (
                  <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="text-sm text-blue-800">
                      ...
                      {previewChapters.length === 1 ? "chapter" : "chapters"}{" "}
                  ...
                  {enhancedChapterData && enhancedChapterData.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm mt-2">
                        Enhanced data length: {enhancedChapterData?.length || 0}
                      </p>
                    </div>
                  )}
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-purple-600 mb-4">
                            Complete your learning journey with a comprehensive
                            final exam covering all course content. Score 80%+
                ...
                {!isPurchased && !isInstructor && (
                  <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    <p className="text-sm text-yellow-800">
                      ...
                      Purchase the course to unlock all chapters and track your
                      progress through the sequential learning path.
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mt-8">
                  <InstructorBio
                    instructor={{
                      ...
                      bio:
                        instructor.bio ||
                        `Experienced educator with ${instructorCourses} course${
                          instructorCourses !== 1 ? "s" : ""
                        } and ${instructorStudents} student${
                          instructorStudents !== 1 ? "s" : ""
                        }`,
