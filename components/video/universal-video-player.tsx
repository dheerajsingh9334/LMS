...
// Lazy load the enhanced video player for better performance
const EnhancedVideoPlayer = React.lazy(
  () => import("@/components/video/enhanced-video-player"),
);
...
export const UniversalVideoPlayer = ({
  ...
  return (
    <div
      className={`relative aspect-video bg-gray-200 rounded-lg flex items-center justify-center ${className}`}
    >
